...
PM 인턴 워크샵에서는 이렇게 말하면 됩니다.

> 기획서를 노션에 등록해줘

> 이번 주 리뷰 만들어줘

**`/pm-be-ready`** 로 불러도 됩니다. (노션 커넥터 연결이 먼저 필요합니다 — 워크샵 8일차)
...
- **pm-be-ready** (PM 인턴 플러그인): 두 가지를 합니다. ① 기획서(PRD)를 읽어 **노션 워크스페이스에
  프로젝트 1개와 테스크 N개로 자동 기록**합니다. ② 한 주에 무슨 일이 있었는지 읽어 **주간 리뷰 보고서**를
  씁니다 — 완료율·프로젝트별 진행률 표와 함께, 어느 프로젝트에서 무엇을 끝냈고 무엇이 마감을 넘겼는지
  **눌러서 열리는 링크로** 적습니다. 회고와 다음 주 계획 두 칸은 비워두고 넘깁니다.
  쓰기 전에 계획을 보여주고 확인을 받으며, 만들기만 하고 수정·삭제는 하지 않습니다.
